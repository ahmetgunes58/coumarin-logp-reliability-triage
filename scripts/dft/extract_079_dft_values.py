...
from corrected CMR_GOLD_079 ORCA output.
Compatible with Python 2/3 style environments.
"""

import re

OUT_FILE = "CMR_GOLD_079_sp_charge_clean.out"
XYZ_FILE = "geom.xyz"
...
def main():
    ...
    print("=" * 72)
    print("CMR_GOLD_079 corrected DFT extraction")
    print("=" * 72)
    ...
    print("N atom count:", len(n_indices_zero))
