...
SMILES = "O=C2OC1=CC=CC=C1C(=C2)C3=NOC=N3"

OUT_XYZ = "CMR_GOLD_043_correct_3D.xyz"
OUT_SDF = "CMR_GOLD_043_correct_3D.sdf"
OUT_TXT = "CMR_GOLD_043_correct_3D_check.txt"
OUT_PNG = "CMR_GOLD_043_structure_check.png"
...
mol_h.SetProp("_Name", "CMR_GOLD_043_correct_3D")
...
with open(OUT_XYZ, "w") as f:
    ...
    f.write("CMR_GOLD_043 correct 3D; generated from verified SMILES; best conformer {}\n".format(best_cid))
...
Draw.MolToFile(mol, OUT_PNG, size=(1200, 800))

with open(OUT_TXT, "w") as f:
    f.write("CMR_GOLD_043 structure verification\n")
    f.write("=" * 72 + "\n")
