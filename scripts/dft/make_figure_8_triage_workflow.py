# -*- coding: utf-8 -*-
"""
Figure 8 FINAL — Retrospective FM taxonomy + prospective reliability-triage workflow

Key design principle:
- Panel A is retrospective and dataset-derived. FM classes depend on experimental logP.
- Panel B is prospective and pre-experimental. It does NOT assign FM1 directly.
- Prospective use flags reliability alerts using structure, N count, predicted consensus logP,
  and predictor disagreement / Spread4.
- No numerical correction equation is proposed.
- No independently trained classifier is claimed.
...
# Increased spacing and slightly larger cards for cleaner final layout
card_h = 0.080
card_gap = 0.018
card_y_start = 0.583
...
workflow_boxes = [
    ...
    },
    {
        "y": 0.470,
        "h": 0.140,
        "title": "Prospective reliability alerts",
        "body": (
...
arrow(ax, (right_x + right_w / 2, 0.470), (right_x + right_w / 2, 0.440), color="#555555")
arrow(ax, (right_x + right_w / 2, 0.292), (right_x + right_w / 2, 0.253), color="#555555")

# Diagonal connector from Panel A to Panel B intentionally removed for cleaner final layout.
...
footer = (
    "Prospective alerts do not assign FM1 directly: FM1 requires experimental logP. "
