# -*- coding: utf-8 -*-
"""
Extract Mulliken and Loewdin atomic charges for imported old DFT anchors
whose charge CSV files are missing in the current repository layout.
...
Combined outputs:
data/processed/Dataset_S36_imported_DFT_anchor_Mulliken_Loewdin_charges.csv
data/processed/Dataset_S36_imported_DFT_anchor_heavy_atom_charges.csv
data/processed/Dataset_S36_imported_DFT_anchor_charge_extraction_report.txt
"""
...
TARGET_IDS = ["CMR_GOLD_043", "CMR_GOLD_055", "CMR_GOLD_058", "CMR_GOLD_079"]
...
def main():
    ...
    out_all = DATA / "Dataset_S36_imported_DFT_anchor_Mulliken_Loewdin_charges.csv"
    out_heavy = DATA / "Dataset_S36_imported_DFT_anchor_heavy_atom_charges.csv"
    out_report = DATA / "Dataset_S36_imported_DFT_anchor_charge_extraction_report.txt"
    ...
    with open(out_report, "w", encoding="utf-8") as f:
        f.write("Imported DFT anchor charge extraction report\n")
        f.write("=" * 70 + "\n\n")
        f.write("\n".join(report_lines))
        f.write("\nCombined outputs:\n")
        f.write(str(out_all) + "\n")
    ...
    print("\nImported-anchor Mulliken/Löwdin charge extraction tamamlandı.")
