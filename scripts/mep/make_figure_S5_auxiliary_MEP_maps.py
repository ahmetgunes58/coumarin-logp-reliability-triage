...
for CMR_GOLD_055 and CMR_GOLD_079 using a top-down / near top-down protocol.
...
# Top-down / near top-down protocol:
# - No aggressive 3D tilt
# - Only a small in-plane rotation for CMR_GOLD_079 to improve readability
ORIENTATION = {
    "CMR_GOLD_055": {"rot_x": 0.0, "rot_y": 0.0, "rot_z": 0.0},
    "CMR_GOLD_079": {"rot_x": 20.0, "rot_y": 0.0, "rot_z": 8.0},
}
...
SURFACE_OPACITY = 0.48
SURFACE_AMBIENT = 0.14
SURFACE_DIFFUSE = 0.80
SURFACE_SPECULAR = 0.02
SURFACE_SPECULAR_POWER = 8

ATOM_OPACITY = 1.00
BOND_OPACITY = 1.00
ATOM_RADIUS_HEAVY = 0.38
ATOM_RADIUS_H = 0.23
BOND_RADIUS_HEAVY = 0.125
BOND_RADIUS_H = 0.088
...
def main() -> None:
    print("=" * 72)
    print("Preparing Figure S5 auxiliary MEP maps - topdown protocol trial")
